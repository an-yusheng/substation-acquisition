 ...
 */
package com.substation.acquisition.modules.mnt.service.impl;

import cn.hutool.core.date.DatePattern;
import cn.hutool.core.date.DateUtil;
import com.substation.acquisition.modules.mnt.repository.DeployRepository;
import com.substation.acquisition.utils.*;
import lombok.RequiredArgsConstructor;
import lombok.extern.slf4j.Slf4j;
import com.substation.acquisition.exception.BadRequestException;
import com.substation.acquisition.modules.mnt.domain.App;
import com.substation.acquisition.modules.mnt.domain.Deploy;
import com.substation.acquisition.modules.mnt.domain.DeployHistory;
import com.substation.acquisition.modules.mnt.domain.ServerDeploy;
import com.substation.acquisition.modules.mnt.service.DeployHistoryService;
import com.substation.acquisition.modules.mnt.service.DeployService;
import com.substation.acquisition.modules.mnt.service.ServerDeployService;
import com.substation.acquisition.modules.mnt.service.dto.AppDto;
import com.substation.acquisition.modules.mnt.service.dto.DeployDto;
import com.substation.acquisition.modules.mnt.service.dto.DeployQueryCriteria;
import com.substation.acquisition.modules.mnt.service.dto.ServerDeployDto;
import com.substation.acquisition.modules.mnt.service.mapstruct.DeployMapper;
import com.substation.acquisition.modules.mnt.util.ExecuteShellUtil;
import com.substation.acquisition.modules.mnt.util.ScpClientUtil;
import com.substation.acquisition.modules.mnt.websocket.MsgType;
import com.substation.acquisition.modules.mnt.websocket.SocketMsg;
import com.substation.acquisition.modules.mnt.websocket.WebSocketServer;
import com.substation.acquisition.utils.*;
